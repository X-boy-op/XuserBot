...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "XuserBot")
        ...
        # set blacklist_chats where you do not want X user Bot features
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/X-boy-op/XuserBot"
        )
        ALIVE_IMAGE = os.environ.get(
            "ALIVE_IMAGE", "https://telegra.ph/file/8dbf5a1a618c0b756bd1a.jpg"
        )
        ASSISTANT_START_PIC = os.environ.get(
            "ASSISTANT_START_PIC",
            "https://telegra.ph/file/8dbf5a1a618c0b756bd1a.jpg",
        )
